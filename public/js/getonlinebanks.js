jQuery(document).ready(function() {
	...
	jQuery('#tryme').click(function(){
		...
		var qcurrency = jQuery('#Currency').text();
		// var requrl = 'http://stg.paywalo.com/api/Common/Banks';

		if (qcurrency === 'Currency') {
            var requrl = 'http://stg.paywalo.com/api/Common/OnlineBanks';
        } else {
            var requrl = 'http://stg.paywalo.com/api/Common/OnlineBanks?currency=' + qcurrency;
        }
    ...
    jQuery('.chcurrency').on("click", function(e){
        // alert('test');
        jQuery('#Currency').text(this.text);
