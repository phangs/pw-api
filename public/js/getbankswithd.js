jQuery(document).ready(function() {
    ...
    console.log('Get Banks - Withdrawal Loaded');
	...
	jQuery('#tryme').click(function(){
		...
		if (qcountry === 'Country') {
            var requrl = 'http://stg.paywalo.com/api/Common/WithdrawalBanks';
        } else {
            var requrl = 'http://stg.paywalo.com/api/Common/WithdrawalBanks?country=' + qcountry;
        }
